      ...
      child: BlocListener<AuthenticationCubit, AuthenticationState>(
        listener: (context, state) {
          ...
          if(state.status == LoginStatus.failure){
            ...
            var snackBar = const SnackBar(content: Text("Successfully!"), backgroundColor: Colors.blue);
          ...
          if(state.authException != null){
            showAlertDialog(context: context, title: "Login Failed", content: state.authException!.errorMessage(context),titleButton: 'CLOSE', colorContent: context.appColors.textBlack, rightAction: (){
              context.pop();
                      ...
                      children: [
                        Container(
                            ...
                            child: Text(context.l10n.task_management,
                                style: context.textTheme.titleLarge
                                    ?.copyWith(color: context.appColors
                                    .textWhite))),
                        ...
                        PasswordField(
                          onTextChange: (content) {
                            context.read<AuthenticationCubit>().setPassword(
                                content);
                          },
...
Widget _usernameTF(BuildContext context, ValidateProvide provider,) {
